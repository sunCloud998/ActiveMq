...
/**
 * 发布订阅消息消费者1
 * @Description: ConsumerTopicOne.java
 * @Author: sunfayun
 * @Date: 2015/08/12
 * @Time: 下午2:52
 * @Version 1.0
...
public class ConsumerTopicOne {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ConsumerTopicOne.class);
...
//    private static final String subject = "test.topic";
    ...
    public static void main(String[] args) {
        ConsumerTopicOne consumerTopicOne = new ConsumerTopicOne();
        consumerTopicOne.receiveMessage();
    }
            ...
            consumer.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message message) {
                    ...
                    try {
                        ...
                        logger.info("发布订阅消费者【1】接收到消息：{}", msg);
                        session.commit();
                        Thread.sleep(2000);
